...
export default function SafetyPage() {
    ...
    try {
      const response = await fetch("http://localhost:5000/api/incidents", {
        ...
        body: JSON.stringify({
          tour_id: selectedTourId,
          reported_by: 1, // Mocked user id
          title: setReportForm.title,
          description: setReportForm.description,
          location: setReportForm.location,
          severity: ReportingObserver,
          status: "OPEN",
        }),
      });
  ...
  function setReportForm(arg0: any): void {
    throw new Error("Function not implemented.");
  }

  function setReportingSeverity(value: string): void {
    throw new Error("Function not implemented.");
  }
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500">
            Real-time incident tracking and SOS management.
          </p>
        </div>
                    ...
                    <div className="flex-1">
                      ...
                      <div className="mt-4 flex items-center space-x-4">
                        ...
                        <span className="text-xs text-slate-400">
                          Reported by:{" "}
                          {incident.profiles?.full_name || "System"}
                        </span>
                      </div>
                    </div>
                  </div>
        ...
        <div className="space-y-6">
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-1 mt-2 pt-2 border-t border-slate-200">
                      ...
                      <p className="text-xs font-bold text-slate-700">
                        {p.profiles?.emergency_contact_name}:{" "}
                        {p.profiles?.emergency_contact_phone}
                      </p>
                    </div>
                  </div>
                ))
          ...
          <div className="bg-white rounded-2xl p-6 border border-slate-100 shadow-sm">
            ...
            <p className="text-sm text-slate-500 leading-relaxed mb-6">
              Quickly find hospitals, clinics, and pharmacies near your current
              itinerary stop.
            </p>
            ...
            <form onSubmit={handleReportIncident} className="p-6 space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div className="col-span-2">
                  ...
                  <input
                    ...
                    value={setReportForm.title}
                    onChange={(e) =>
                      setReportForm({ ...setReportForm, title: e.target.value })
                    }
              ...
              <div>
                ...
                <textarea
                  ...
                  value={setReportForm.description}
                  onChange={(e) =>
                    setReportForm({
                      ...setReportForm,
