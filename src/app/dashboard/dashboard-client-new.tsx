...
export function DashboardClient({ organizations, tours, userRole }: DashboardClientProps) {
  ...
  return <div>Access denied. Please contact administrator.</div>;
}
          ...
          <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }}>
            <Card className="rounded-3xl border-2 border-white hover:border-blue-100 transition-all duration-300">
              <CardHeader>
                ...
                <CardDescription>Tours you are enrolled in</CardDescription>
              </CardHeader>
              <CardContent>
                {tours.length === 0 ? (
                  <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <Card className="rounded-3xl border-2 border-white hover:border-blue-100 transition-all duration-300 bg-gradient-to-br from-blue-50 to-blue-100/50">
              <CardContent className="p-6">
                ...
                <div className="space-y-3 text-sm text-slate-600">
                  <p>• Follow all tour leader instructions</p>
                  <p>• Report any emergencies immediately</p>
                  <p>• Stay with your group at all times</p>
                </div>
              </CardContent>
            </Card>
          </motion.div>
